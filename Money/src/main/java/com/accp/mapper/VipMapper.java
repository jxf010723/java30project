...
public interface VipMapper {
    ...
    @Select("SELECT `vip_id` AS vipId,`vip_name` AS vipName,`vip_phone` AS vipPhone,`vipType_name` AS viptypeName,`vip_turnover` AS vipTurnover,`transaction_price` AS price,`balance` AS balance,`integral` AS integral,\r\n" + 
    		"	(\r\n" + 
